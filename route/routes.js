...
//Navigate to update customers page and displaying all customers details
        ...
        Stock.find(function(err,medicineData){
            Client.find(function(err,clientData){
                Sales.find(function(err,salesData){
                    ...
                    res.render('salesDetails',{user:username_camelcase, title:'MSS- Sales Details', getSales:salesData, getMedicine: medicineData, getClient: clientData},(error, html) =>{
                        if(error){ 
                            console.log(error) 
                            next(error)
                            return
